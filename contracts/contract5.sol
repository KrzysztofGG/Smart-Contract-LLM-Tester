...
contract GFREN is ERC20, Ownable {
    ...
    constructor() ERC20("General Frenchie", unicode"GFREN") {
        ...
        maxTx = 4_044_044_044 * 1e18; // 4% from total supply
        maxWallets = 4_044_044_044 * 1e18; // 4% from total supply
        ...
        MarketingWallet = address(0xeCD02738743BEcDa99256ACD4769C9625E1cfE8c);
        DevWallet = address(0xeCD02738743BEcDa99256ACD4769C9625E1cfE8c);
        ShareWallet = address(0xeCD02738743BEcDa99256ACD4769C9625E1cfE8c);
