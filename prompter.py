...
class Prompter():
    ...
    def ask_model(self, prompt):
        ...
        output = self.model.generate(input_ids, max_length=50, num_return_sequences=1) #TODO: dunno about these parameters
        output_decoded = self.tokenizer(output[0],  skip_special_tokens=True)
